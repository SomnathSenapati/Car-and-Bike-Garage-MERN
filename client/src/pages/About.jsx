    ...
    <>
      ...
      <div className="container-fluid fact bg-dark my-5 py-5">
        <div className="container">
          <div className="row g-4">
            {[
              { icon: "fa-check", value: "5", text: "Years Experience" },
              {
                icon: "fa-users-cog",
                value: "34",
                text: "Expert Technicians",
              },
              { icon: "fa-users", value: "397", text: "Satisfied Clients" },
              { icon: "fa-car", value: "31", text: "Complete Projects" },
            ].map((fact, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <p className="text-white mb-0">{fact.text}</p>
              </div>
            ))}
          </div>
        </div>
